...
const DataStore = window.extension3dExporterDataStore;
const Pcb3D = window.extension3dExporterPcb3D;

loadJs("https://cdn.jsdelivr.net/npm/jsts@2.6.1/dist/jsts.js")
  .then(() =>
    loadJs("https://cdn.jsdelivr.net/npm/three@0.123.0/build/three.min.js")
  )
  .then(() =>
    loadJs(
